// Direct copy from lvgl_touch_cst816s_i2c.c plus a few very small changes. Not officially finished, but it is working
...
void cst328_lvgl_touch_cb(lv_indev_t *indev, lv_indev_data_t *data)
{
    ...
    // Get coordinates
    bool pressed = esp_lcd_touch_get_coordinates(touch_handle, x, y, strength, &touch_cnt, 5);
...
lv_indev_t *lvgl_touch_init()
{
    ...
    const i2c_config_t i2c_config = {
        ...
        .sda_io_num = CST328_I2C_CONFIG_SDA_IO_NUM,
        .scl_io_num = CST328_I2C_CONFIG_SCL_IO_NUM,
        .sda_pullup_en = CST328_I2C_CONFIG_SDA_PULLUP_EN,
        .scl_pullup_en = CST328_I2C_CONFIG_SCL_PULLUP_EN,
        .master = {
            .clk_speed = CST328_I2C_CONFIG_MASTER_CLK_SPEED},
        .clk_flags = CST328_I2C_CONFIG_CLK_FLAGS};
    ...
    ESP_ERROR_CHECK(i2c_param_config(CST328_I2C_HOST, &i2c_config));
    ESP_ERROR_CHECK(i2c_driver_install(CST328_I2C_HOST, i2c_config.mode, 0, 0, 0));

    // Create IO handle
    const esp_lcd_panel_io_i2c_config_t io_i2c_config = {
        .dev_addr = CST328_IO_I2C_CONFIG_DEV_ADDRESS,
        .control_phase_bytes = CST328_IO_I2C_CONFIG_CONTROL_PHASE_BYTES,
        .user_ctx = indev,
        .dc_bit_offset = CST328_IO_I2C_CONFIG_DC_BIT_OFFSET,
        .lcd_cmd_bits = CST328_IO_I2C_CONFIG_LCD_CMD_BITS,
        .lcd_param_bits = CST328_IO_I2C_CONFIG_LCD_PARAM_BITS,
        .flags = {
            .dc_low_on_data = CST328_IO_I2C_CONFIG_FLAGS_DC_LOW_ON_DATA,
            .disable_control_phase = CST328_IO_I2C_CONFIG_FLAGS_DISABLE_CONTROL_PHASE}};
    ...
    ESP_ERROR_CHECK(esp_lcd_new_panel_io_i2c((esp_lcd_i2c_bus_handle_t)CST328_I2C_HOST, &io_i2c_config, &io_handle));

    // Create touch configuration
    const esp_lcd_touch_config_t touch_config = {
        .x_max = CST328_TOUCH_CONFIG_X_MAX,
        .y_max = CST328_TOUCH_CONFIG_Y_MAX,
        .rst_gpio_num = CST328_TOUCH_CONFIG_RST_GPIO_NUM,
        .int_gpio_num = CST328_TOUCH_CONFIG_INT_GPIO_NUM,
        .levels = {
            .reset = CST328_TOUCH_CONFIG_LEVELS_RESET,
            .interrupt = CST328_TOUCH_CONFIG_LEVELS_INTERRUPT},
    ...
    ESP_ERROR_CHECK(esp_lcd_touch_new_i2c_cst328(io_handle, &touch_config, &touch_handle));

    indev->type = LV_INDEV_TYPE_POINTER;
    indev->user_data = touch_handle;
    indev->read_cb = cst328_lvgl_touch_cb;
